...
from core.web3.method_formatters import get_error_formatters
...
class Method(Generic[TFunc]):
    ...
    def __init__(
        ...
        self.error_formatter = error_formatters  # 源码未用到初始化时的error_formatters，此处将定义Method实例时的error_formatters添加至错误处理器的首端
    ...
    def process_params(
        ...
        response_formatters = (self.result_formatters(method, module),
                               self.error_formatters(method, self.error_formatter),     # 传入self.error_formatter
